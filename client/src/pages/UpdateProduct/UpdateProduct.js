...
export default function UpdateProduct() {
  ...
  // const handleUpdateToTheCart = () => {
  //   // Create the updated product object with updated quantity, size, and price
  ...
  //   const updatedCart = cookies.cart.map((item) => {
  //     if (item.id === id && item.size === size) {
  //       item.size = size
  //       item.quantity = quantity        // Update the matching product in the cart
  //       return cookies.cart;
  //     }
  //     return
  //   });
        ...
        <div className='product-detail-right'>
          ...
          <div>
            ...
            <div className='product-detail-right-size'>
              <div className='product-detail-right-size-box' value={size}>
            ...
            <button className='add-to-cart-btn' onClick={() => handleUpdateToTheCart()}>Add to cart</button>
